...
module.exports.getAllRowsOfSpace = catchAsyncError(async (spaceName) => {
...
module.exports.addSeatsToSpace = catchAsyncError(
  async (spaceName, numberOfSeats) => {
...
module.exports.cutColumnToSpecificSeats = catchAsyncError(
  async (spaceName, wantedSeats) => {
    const currentSeats = await this.getAllRowsOfSpace(spaceName);
