...
module.exports.checkUserDoesNotExist = catchAsyncError(
  async (req, res, next) => {
...
module.exports.runAdminUpdateUserValidation = catchAsyncError(
  async (req, res, next) => {
...
module.exports.forgotPasswordValidations = catchAsyncError(
  async (req, res, next) => {
...
module.exports.checkMobileNumberExist = catchAsyncError(
  async (req, res, next) => {
    const user = await findUserByPhoneNumber(req);
    if (!user.length) {
      return next();
    }
...
module.exports.updatePasswordValidations = catchAsyncError(
  async (req, res, next) => {
...
module.exports.verifyUserPassword = catchAsyncError(async (req, res, next) => {
  ...
  let hashedPassword = req.user[0].password;
  let correctPassword = await passwordIsCorrect(
    enteredPassword,
    hashedPassword
  );
  if (correctPassword) {
...
module.exports.checkUserDoExistQueryParams = catchAsyncError(
  async (req, res, next) => {
